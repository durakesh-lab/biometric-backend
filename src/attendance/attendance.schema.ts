...
export class Attendance extends Document {
  ...
  @Prop({ required: false }) editNote?: string;
  @Prop({ required: false, default: false }) isManualEdit?: boolean;
  @Prop({ required: false }) editedBy?: string;
  @Prop({ required: false }) editedAt?: Date;
}
